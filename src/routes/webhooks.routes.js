...
} = require("../controllers/smsWebhook.controller");
...
router.get("/orange-sms/dlr", genericWebhookLimiter, orangeSmsDlrWebhookProbe);
router.head("/orange-sms/dlr", genericWebhookLimiter, orangeSmsDlrWebhookProbe);
