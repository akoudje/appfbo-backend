  ...
  try {
    ...
    return res.json({
      ...
      payments: {
        ...
        piSpi: isCiv ? settings?.enablePiSpi ?? false : false,
      },
      piSpi: {
        alias: settings?.piSpiAlias || null,
        merchantName: settings?.piSpiMerchantName || null,
        qrImageUrl: settings?.piSpiQrImageUrl || null,
        instructions: settings?.piSpiInstructions || null,
      },
      ecobankPay: {
